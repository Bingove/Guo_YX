...
public class LoggerAdvice {
    ...
    @Before("within(com.xhs.center..*) && @annotation(loggerManage)")
    ...
    @AfterReturning("within(com.xhs.center..*) && @annotation(loggerManage)")
    public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
        logger.debug("执行 " + loggerManage.description() + " 结束");
    }

    @AfterThrowing(pointcut = "within(com.xhs.center..*) && @annotation(loggerManage)", throwing = "ex")
